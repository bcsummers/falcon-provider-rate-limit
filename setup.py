# -*- coding: utf-8 -*-
"""Setup for falcon-provider-rate-limit package."""
# standard library
import os
...
metadata_file = os.path.join(
    os.path.abspath(os.path.dirname(__file__)), 'falcon_provider_rate_limit', '__metadata__.py'
)
...
dev_packages = [
    ...
    'radon',
    'xenon',
    'falcon-provider-memcache @ git+https://github.com/bcsummers/falcon-provider-memcache@develop',
    'falcon-provider-redis @ git+https://github.com/bcsummers/falcon-provider-redis@develop',
]
extras_require = {
    'redis': [
...
setup(
    ...
    package_dir={'falcon_provider_rate_limit': 'falcon_provider_rate_limit'},
    project_urls={
        'Documentation': 'https://github.com/bcsummers/falcon-provider-rate-limit/',
        'Source': 'https://github.com/bcsummers/falcon-provider-rate-limit/',
    },
    python_requires='>=3.6',
    scripts=[],
    test_suite='tests',
